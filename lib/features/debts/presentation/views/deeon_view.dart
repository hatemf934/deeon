...
import 'package:deeon/features/debts/presentation/views/widgets/body_of_deeon_view.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: ColorManager.primaryColor,
        title: Text(S.of(context).detailsCustomer, style: Styles.textStyle25),
      ),
